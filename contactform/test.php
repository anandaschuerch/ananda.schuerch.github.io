...
$mailcontent .= "Bei Fragen oder Problemen steht Ihnen jederzeit unser Support zur Verfügung.\n\nFAQ Seite: https://www.kontaktformular.com/faq-script-php-kontakt-formular.html\nTutorial Seite: https://www.kontaktformular.com/kontaktformular-erstellen-tutorial.html\n";
		...
		if($success){
    		    echo "<div style='display: flex;align-items: center;justify-content: center;font-family: Arial, sans-serif;font-size: 16px;color:green;margin-top:50px;font-weight:bold;'>Die Test-Mail wurde erfolgreich versandt.</div><br /><div style='display: flex;align-items: center;justify-content: center;font-family: Arial, sans-serif;font-size: 16px;color:green;text-align:center;'>Sie sollten innerhalb der nächsten Sekunden eine E-Mail erhalten.</div>
		 
		 <br />
		 <div style='display: flex;align-items: center;justify-content: center;font-family: Arial, sans-serif;font-size: 16px;color:green;'> <a style='font-family: Arial, sans-serif;color:blue;text-decoration:underline;font-size: 16px;' target=_blank href=https://www.kontaktformular.com/faq-script-php-kontakt-formular.html#keine-mail-erhalten>Keine Mail erhalten? Bitte hier klicken!</a></div>
		 		 <br />
		 <div style='line-height:25px;margin-left:10px;margin-right:10px;padding-left:5px;padding-right:5px;'>
		 <div style='display: flex;align-items: center;justify-content: center;font-family: Arial, sans-serif;font-size: 16px;color:green;margin-top:0px;font-weight:bold;'>Bitte beachten Sie, dass einige Hosting-Anbieter den E-Mail Versand über dieses Test-Formular blockieren.</div>
		 
		 <div style='display: flex;align-items: center;justify-content: center;font-family: Arial, sans-serif;font-size: 16px;color:green;margin-top:0px;font-weight:bold;'>Führen Sie den Test in diesem Fall direkt über das Kontaktformular (kontakt.php) aus, indem Sie Ihre E-Mail Adresse in die Datei config.php eintragen.</div>
		 </div>";
            }
...
Sie erhalten keine Bestätigung nach dem Klick auf Senden?<br /><span>Zu unseren FAQ Artikeln:</span><br />
    <a href="https://www.kontaktformular.com/webhoster-hosteurope.html" target="_blank" style="color:white;">Hosteurope, Strato und IONOS (1und1) Kunden: Bitte diese Infos beachten!</a><br />
    <a href="https://www.kontaktformular.com/faq-script-php-kontakt-formular.html#keine-mail-erhalten" target="_blank" style="color:white;">Ich erhalte über das Kontaktformular keine E-Mail?</a><br /><span style="color:#eee;"><span style="text-decoration:underline;">Hinweis</span><br />Bitte beachten Sie, dass einige Hosting-Anbieter den E-Mail Versand über dieses Test-Formular blockieren.<br /> Führen Sie den Test in diesem Fall direkt über das Kontaktformular (kontakt.php) aus, indem Sie Ihre E-Mail Adresse in die Datei config.php eintragen. </span>
</div><br />
					
					<input type="submit" class="senden" name="kf-km" value="Senden" style="font-size:18px;font-weight:bold;height:3rem;" />
