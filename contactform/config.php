...
$empfaenger = "diemistelkunst@gmail.com";  // Ihre E-Mail Adresse (zwischen den Anführungszeichen) Bei Problemen: https://www.kontaktformular.com/faq-script-php-kontakt-formular.html#keine-mail-erhalten

$ihrname = "MAR";  // Ihr Name (zwischen den Anführungszeichen)
...
$cfg['Badwordfields'] = 'name, email, betreff, nachricht';  //   Die Namen der Felder, die bei dem Bad Word Filter geprüft werden sollen - Groß- und Kleinschreibung beachten!
